...
import hfh from "@/assets/HomePages/PHOTOS HONEY FOR HONEY (1).jpg";
...
const Promo = () => {
  return (
    <div className="md:container px-3 mt-12">
      ...
      {/* HFH */}
      <div className="grid grid-cols-1 gap-2 lg:grid-cols-2 place-content-center items-center">
        <div>
          <img src={hfh} alt="" />
        </div>
        ...
        <div className="grid col-start-1 lg:col-start-2 place-content-center md:place-content-end my-4 md:my-0 md:mr-6">
          <div className="grid border full-shadow rounded-xl p-4 max-w-[325px]">
            <span className="grid text-base">Harga awal</span>
            <span className="grid text-lg lg:text-xl text-merah ml-2 font-bold">
              Rp. 158.000
            </span>
            <span className="grid text-2xl md:text-4xl  lg:text-5xl mb-4 ml-3 font-bold">
              BUY 1 GET 1 FREE
            ...
            <div className="flex p-1 lg:p-3">
              ...
              <span className="ml-2">Honey For Honey 150ml</span>
            </div>
            <div className="bg-hijau grid place-content-center rounded-lg mt-4">
              <span className="text-white text-base font-semibold p-2">
                Order Sekarang
